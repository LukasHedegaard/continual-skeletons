        ...
        self.layers = nn.ModuleDict(
            {
                ...
                "layer5": CoStGcnBlock(64, 128, A, CoGraphConv=CoGraphConv, padding="equal", window_size=T - 4 * 8, stride=1),
                ...
                "layer8": CoStGcnBlock(128, 256, A, CoGraphConv=CoGraphConv, padding="equal", window_size=(T - 4 * 8) / 2 - 3 * 8, stride=1),
