...
for subset, modality, pretrained_model in [
    # ("xset", "joint", "weights/str_ntu120_xset_joint.ckpt"),
    # ("xsub", "joint", "weights/str_ntu120_xsub_joint.ckpt"),
    # ("xset", "bone", "weights/str_ntu120_xset_bone.ckpt"),
    ("xsub", "bone", "weights/str_ntu120_xsub_bone.ckpt"),
]:
    subprocess.call(
        [
            "python3",
