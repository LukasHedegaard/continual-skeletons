...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='./nturgbd_raw/nturgb+d_skeletons120/')
    parser.add_argument('--ignored-sample-path',
                        default='./nturgbd_raw/ntu120_samples_with_missing_skeletons.txt')
