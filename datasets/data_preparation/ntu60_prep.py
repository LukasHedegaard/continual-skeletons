...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='./nturgbd_raw/nturgb+d_skeletons60/')
    parser.add_argument('--ignored_sample_path',
                        default='./nturgbd_raw/ntu60_samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='./data/ntu60')
